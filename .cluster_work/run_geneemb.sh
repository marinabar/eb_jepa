#!/bin/bash
# Launch the Tahoe-100M gene-embedding build sharded across the 5 FREE B200s (3-7).
# GPUs 0,1,2 are in use by other projects -> left untouched.
set -u
cd /data/eb_jepa
...
NSHARDS=5
GPUS=(3 4 5 6 7)   # physical GPUs to use (the free ones)
